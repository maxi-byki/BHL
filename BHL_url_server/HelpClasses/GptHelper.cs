...
public class GptHelper
{
    ...
    public static async Task<string> get_response(string question)
    {
        ...
        string prompt = $"You are a cyber security expert, your name is Maxi Bot who responds to questions from corporation employees asking you about the security issues in their company. You should answer their question to ensure maximum safety of company data.";
